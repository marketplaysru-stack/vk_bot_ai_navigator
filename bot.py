...
# -*- coding: utf-8 -*-
"""
AI Навигатор (пульт) – бот для публикации постов в ИИ-группе.
...
# ========== НАСТРОЙКИ (AI НАВИГАТОР) ==========
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN")
VK_TOKEN_AI = os.getenv("VK_TOKEN_AI")
GROUP_ID_AI = int(os.getenv("GROUP_ID_AI", "-240273450"))  # AI группа (отрицательный ID)
...
# ========== ГЕНЕРАТОРЫ КАРТИНОК (AI ТЕМАТИКА) ==========
def random_seed():
...
def handle_command(chat_id, text):
    if text in ("/start", "/help"):
        send_message(chat_id,
            "🤖 Привет! Я бот «AI Навигатор» (пульт).\n"
            "Помогаю публиковать полезные посты об искусственном интеллекте.\n\n"
            "📌 Команды:\n"
