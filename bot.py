...
Порядок: Agnes → Pixazo → Pollinations → Pexels → баннер.
...
# ---------- ГЕНЕРАТОРЫ КАРТИНОК (таймауты 180 секунд) ----------
...
def generate_pixazo_image(prompt):
    logger.info("🔄 Пытаемся получить картинку через Pixazo (таймаут 180 сек)...")
...
# ---------- ЗАПУСК ----------
def main():
    logger.info("🚀 AI Навигатор запущен (таймауты генерации 180 сек)")
