...
# ================== ДИАГНОСТИКА ==================
def diag_check_groq():
    """Возвращает строку отчёта по Groq."""
    if not GROQ_API_KEY:
...
def diag_full():
    """Полная диагностика — возвращает текст для Телеграм."""
    lines = [
