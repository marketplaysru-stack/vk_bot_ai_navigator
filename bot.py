...
# ---------- ГЕНЕРАЦИЯ ТЕКСТА (с Agnes, если доступен) ----------
def generate_text(topic: str) -> str:
    # Пробуем Agnes для текста, если ключ задан
    if AGNES_API_KEY:
        try:
    ...
    # Резервный шаблон (с большим разнообразием)
...
# ---------- ГЕНЕРАТОРЫ КАРТИНОК (с разнообразием) ----------
...
# ----- Hugging Face (с двумя эндпоинтами) -----
...
# ---------- ЗАПУСК ----------
def main():
    logger.info("🚀 AI Навигатор запущен (разнообразные картинки и тексты)")
