...
VK_TOKEN        = "vk1.a.10Y92jGcURRF771nSScfq6RRjzuFDKCr7ViEa5hZktbCJLw_cf4MrESAovRzYAdvhvxoK8bvykaWdyq1VB2zqwKkn9xdw2jTIowgfdRSKIGJApzUlBipV_ttiiu8z9wRaF0dy4Ra_eVwjSHFJdTXJ7FD5hjmCMuT8f09nh7PfDt3nqLsUEjgPIgQKKKBezNc8Cm1283_vUlBBg0tu0TxlQ"
HUGGINGFACE_KEY = "hf_fZYXLbaOaNGsdWvKmASvvweijwHGxYRAg"
PEXELS_KEY      = "U0hYBcu39CAuBculhmhck4b98MmgXQx5emfWFSYwC13tFofENNTXE9RP"
...
DEFAULT_TOPICS = [
    ...
    "Что нужно знать о регулировании AI в России",
    "Как малому бизнесу начать использовать AI",
    "AI и кибербезопасность: что изменилось",
]

# ================== СТИЛИ КАРТИНОК (расширено) ==================
IMG_STYLES = [
...
# ================== ТЕКСТ: структурированный формат ==================
def format_post(topic, raw):
    """Оборачивает текст в красивый формат с заголовком, списком и хештегами."""
    emojis = ["🧠", "🤖", "💡", "⚡", "🔍", "📊", "🚀", "🧩", "🌐", "📌"]
    e = random.choice(emojis)

    # Если raw пришёл от HF — используем как основную часть, иначе шаблон
    ...
    return intro + body + conclusion + hashtags
